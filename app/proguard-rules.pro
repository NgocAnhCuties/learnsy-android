...
-keep,includedescriptorclasses class com.learnsy.app.**$$serializer { *; }
-keepclassmembers class com.learnsy.app.** {
    *** Companion;
}
-keepclasseswithmembers class com.learnsy.app.** {
    kotlinx.serialization.KSerializer serializer(...);
}
...
-keepclassmembers class com.learnsy.app.data.** {
    <fields>;
}
-keepclassmembers class com.learnsy.app.ui.**.* {
    <fields>;
}
